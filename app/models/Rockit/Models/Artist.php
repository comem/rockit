...
class Artist extends \Eloquent {
    ...
    public function links() {
        return $this->hasMany('Rockit\Models\Link');
    }
    ...
    public function genres() {
        return $this->belongsToMany('Rockit\Models\Genre', 'descriptions')->withTrashed()->withPivot('id');
    }
    ...
    public function images() {
        return $this->hasMany('Rockit\Models\Image');
    }
    ...
    public function lineups() {
        return $this->hasMany('Rockit\Models\Lineup')->groupBy('musician_id');
    }
    ...
    public function events() {
        return $this->belongsToMany('Rockit\Models\Event', 'performers')
    ...
    public function musicians() {
        return $this->belongsToMany('Rockit\Models\Musician', 'lineups')->withTrashed()->groupBy('id');
    }

    /**
     * Reduce the scope of the provided query, using a 'name' search filter.
    ...
    /**
     * Reduce the scope of the provided query, using a string that will do a search on the 'stagename', 'first name' and 'last name'.
     * @param \Illuminate\Database\Query\Builder $query The query on which the scope will be applied
