...
class Member extends \Eloquent {
    ...
    public function skills() {
        return $this->belongsToMany('Rockit\Models\Skill', 'fulfillments')->withTrashed();
    }
    ...
    public function events() {
        return $this->belongsToMany('Rockit\Models\Event', 'staffs');
    }
    ...
    public function fulfillments() {
        return $this->hasMany('Rockit\Models\Fulfillment');
    }
