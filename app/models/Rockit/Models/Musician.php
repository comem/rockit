...
class Musician extends \Eloquent {
    ...
    public function instrumentsFor($artist_id) {
        return $this->belongsToMany('Rockit\Models\Instrument', 'lineups')->withTrashed()->where('artist_id', '=', $artist_id);
    }
    ...
    public function instruments() {
        return $this->belongsToMany('Rockit\Models\Instrument', 'lineups')->withTrashed();
    }
    ...
    public function artists() {
        return $this->belongsToMany('Rockit\Models\Artist', 'lineups')->groupBy('id')->withTrashed();
    }
