...
return [
    ...
    'representer' => [
        'created' => "Le représentant ':name' n'a pas pu être créé.",
        'updated' => "Le représentant ':name' n'a pas pu être modifié.",
        'deleted' => "Le représentant ':name' n'a pas pu être supprimé.",
        'restored' => "Le représentant ':name' n'a pas pu être restauré.",
    ],
    'auth' => [
